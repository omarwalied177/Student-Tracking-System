...
namespace StudentTrackingSystem.DAL.Migrations
{
    ...
    [Migration("20250517092025_AddAssignmentSystem")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudentTrackingSystem.DAL.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("StudentTrackingSystem.DAL.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("StudentTrackingSystem.DAL.Data.Models.Assignment", b =>
                {
                    ...
                    b.HasOne("StudentTrackingSystem.DAL.Models.AppUser", "Teacher")
                        .WithMany()
            ...
            modelBuilder.Entity("StudentTrackingSystem.DAL.Data.Models.StudentAssignment", b =>
                {
                    ...
                    b.HasOne("StudentTrackingSystem.DAL.Models.AppUser", "Student")
                        .WithMany()
